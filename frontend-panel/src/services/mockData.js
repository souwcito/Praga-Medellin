...
export const categorias = [
  ...
  { id: 6, nombre: 'Gorras', tallas_opcionales: true, catalogo: 'hombre' },
...
export const subcategorias = [
  ...
  { id: 12, categoria_id: 6, nombre: 'Gorras Originales', tallas: ['Talla única', 'S', 'M', 'L'] },
  { id: 13, categoria_id: 6, nombre: 'Gorras Premium 1.1', tallas: ['Talla única', 'S', 'M', 'L'] },
  { id: 14, categoria_id: 6, nombre: 'Gorras Turcas', tallas: ['Talla única', 'S', 'M', 'L'] },
